...
type Validator interface {
	...
	ValidateStateV2(block *types.Block, state *state.StateDB, res *ProcessResult, stateless bool) error
...
type Processor interface {
	...
	// the transaction messages using the statedb and applying any rewards to both
	// the processor (coinbase) and any included uncles.
	ProcessV2(block *types.Block, statedb *state.StateDB, cfg vm.Config) (*ProcessResult, error)
}
