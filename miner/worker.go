...
type generateParams struct {
	tempTimestamp uint64            // The timestamp for sealing task
...
func (g *generateParams) MilliTimestamp() uint64 { return g.tempTimestamp*1000 + g.millisecondes() }

func (g *generateParams) SecondsTimestamp() uint64 { return g.tempTimestamp }
...
func (w *worker) commitWork(interrupt *atomic.Int32, timestamp int64) {
	...
	work, err := w.prepareWork(&generateParams{
		tempTimestamp: uint64(timestamp),
		coinbase:      coinbase,
	})
	if err != nil {
		return
